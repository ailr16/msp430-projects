...
#define CLOCK_DCO_RESISTOR_DEFAULT            CLOCK_DCO_RESISTOR_INTERNAL

#define CLOCK_SMCLK_SOURCE_REG_OFFSET         3u
#define CLOCK_SMCLK_SOURCE_DCO                0u
#define CLOCK_SMCLK_SOURCE_XT2_LFXT1_VLO      1u
#define CLOCK_SMCLK_SOURCE_DEFAULT            CLOCK_SMCLK_SOURCE_DCO
...
#define CLOCK_SMCLK_DIVIDE_DEFAULT            CLOCK_SMCLK_DIVIDE_1

#define CLOCK_MCLK_SOURCE_REG_OFFSET          6u
#define CLOCK_MCLK_SOURCE_DCO                 0u
#define CLOCK_MCLK_SOURCE_XT2_LFXT1_VLO       2u
#define CLOCK_MCLK_SOURCE_LFXT1_VLO           3u
#define CLOCK_MCLK_SOURCE_DEFAULT             CLOCK_MCLK_SOURCE_DCO
...
#define CLOCK_MCLK_DIVIDE_DEFAULT             CLOCK_MCLK_DIVIDE_1

#define CLOCK_DCO_FREQUENCY_RANGE_REG_OFFSET  0u
...
#define CLOCK_ACLK_DIVIDE_DEFAULT             CLOCK_ACLK_DIVIDE_1

#define CLOCK_XT2_ENABLED_REG_OFFSET          7u
#define CLOCK_XT2_ENABLED_TRUE                0u
#define CLOCK_XT2_ENABLED_FALSE               1u
#define CLOCK_XT2_ENABLED_DEFAULT             CLOCK_XT2_ENABLED_FALSE
...
#define CLOCK_XT2_RANGE_DEFAULT              CLOCK_XT2_RANGE_400K_to_1M

#define CLOCK_XT1_MODE_REG_OFFSET          6u
#define CLOCK_XT1_MODE_LOW_FREQUENCY       0u
#define CLOCK_XT1_MODE_HIGH_FREQUENCY      1u
#define CLOCK_XT1_MODE_DEFAULT             CLOCK_XT1_MODE_LOW_FREQUENCY
...
#define CLOCK_XT1_CLOCK_SELECT_DEFAULT                 CLOCK_XT1_CLOCK_SELECT_LF_32768K
